...
export function changeParticlesSequential(particles: import("./Classes").Particle[]) {
  let i = 0;
...
export function changeParticlesConcurrent(particles: import("./Classes").Particle[]) {
  const moveSequence = [
    [2, 0],
    [0, 1],
    [-2, 0],
